         ...
         <div class="sidebar">
             ...
             <nav class="mt-2">
               ...
               with font-awesome or any other icon font library -->
                     ...
                     <li
                         class="nav-item has-treeview {{ request()->segment(1) == 'allusers' ? 'menu-open' : '' }}">
                         <a href="{{ url('admin/allusers') }}"
                             class="nav-link {{ request()->segment(1) == 'allusers' ? 'active' : '' }}">
                 ...
                 @else
                     ...
                     <li class="nav-item" @if ($segment == 'environments') class="active" @endif>
