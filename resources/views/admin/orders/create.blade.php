                            ...
                            <div class="col-md-2" v-for="product in inventory" :key="product.id">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="card-text">Regular Weight: <br>
                                            <b>@{{ product . regular_weight }}</b> KG
                                        </div>
                                        <p class="card-text mt--1">Special Weight: <br>
                                            <b>@{{ product . special_weight }}</b>
                                            KG
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-row mt-2">
                                    ...
                                    <div class="form-group col-md-1 pl-0">
                                        ...
                                        <button @click="saveOrder()" class="btn bg-green-btn form-control">Add</button>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <table class="table border-bottom-0 table-bordered text-center ">
                                            <thead>
                                                <tr>
                                                    <th scope="col">#</th>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <button @click="createOrder()" class="btn bg-green-btn" id="create-order">Create
                                            Order</button>
                                    </div>
                                </div>
                            </div>
