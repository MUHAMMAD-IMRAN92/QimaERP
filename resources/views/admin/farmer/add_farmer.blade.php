                                    ...
                                    <div class="card-body col-md-6 text-uppercase letter-spacing-1">
                                            ...
                                            <select class="form-control input-add-inception" name="village_code"
                                                ...
                                                @foreach ($villages as $row)
                                                    <option value="{{ $row->village_code }}">
                                                        {{ $row->village_title . '  (' . $row->village_code . ')' }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            @error('village_code')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="farmer_name" class="form-control"
                                                id="exampleInputPassword1" value="" name="farmer_name"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="farmer_nicn" class="form-control" value=""
                                                name="farmer_nicn" placeholder="Farmer CNIC" @error('farmer_nicn')
                                                is-invalid @enderror>
                                            @error('farmer_nicn')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="price_per_kg" class="form-control" value=""
                                                name="price_per_kg" placeholder="Price Per Kg" @error('price_per_kg')
                                                is-invalid @enderror>
                                            @error('price_per_kg')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="cup_score" class="form-control" value=""
                                                name="cup_score" placeholder="Cupping Score" @error('') is-invalid
                                                @enderror>
                                            @error('')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="cup_score" class="form-control" value=""
                                                name="house_hold" placeholder="Cupping Score" @error('') is-invalid
                                                @enderror>
                                            @error('')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="cup_score" class="form-control" value=""
                                                name="farm_size" placeholder="Farm Size" @error('') is-invalid @enderror>
                                            @error('')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
