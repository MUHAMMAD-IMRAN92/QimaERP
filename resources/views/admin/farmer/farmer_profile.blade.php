    ...
    <section class="content-header mx-lg-5">
        ...
        <div class="row">
            <div class="col-md-4 my-3">
                ...
                <td> <img class="famerimg" src="{{ Storage::disk('s3')->url('images/' . 'dumy.png') }}" style="width: 300px ; height:300px; border-radius:50%; border: 1px solid gray;" alt=""></td>
                @else
                <td> <img class="famerimg" style="width: 300px ; height:300px; border-radius:50%; border: 1px solid gray;" src="{{ Storage::disk('s3')->url('images/' . $farmer->image) }}" {{-- src="https://qima.s3.us-east-2.amazonaws.com/images/1631859778.JPG" --}} alt=" no img"></td>
                @endif
        ...
        <div class="row ml-2 blacklink letter-spacing-1">
            ...
            <span class="ml-2 hover" id="lastyear"> 2020
                SEASON</a></span>
            &nbsp |
            <span class="ml-2 hover" style="font-weight: bold; text-decoration: underline;"> <a href="{{ route('farmer.profile', $farmer) }}">ALL
                    TIME</a></span>
        </div>
        <hr class="ml-2">
        ...
        <div class="row ml-2" id="farmer-inovices">
            <div class="col-sm-1 color p-0 ml-0">
                ...
                <img class="famerimg" src="{{ Storage::disk('s3')->url('images/' . 'dumy.png') }}" style="max-width: 100%; height: 100%;" alt="" id="idimage">

                @else
                <img class="famerimg" style="max-width: 100%; height: 100%;" src="{{ Storage::disk('s3')->url('images/' . $farmer->cnicImage) }}" alt="no img" id="idimage">
                @endif
