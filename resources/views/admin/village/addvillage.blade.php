                                ...
                                <span aria-hidden="true">&times;</span>
                                    ...
                                    <div class="card-body col-md-6 text-uppercase letter-spacing-1">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="altitude" class="form-control" value=""
                                                name="altitude" placeholder="Altitude" @error('altitude') is-invalid
                                                @enderror>
                                            @error('altitude')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" id="" value="" name="images[]" multiple
                                                        placeholder="" @error('village_image') is-invalid @enderror>
                                                    @error('village_image')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
