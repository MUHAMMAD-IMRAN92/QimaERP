                      ...
                      <ul>
                        ...
                        <div class="card-body col-md-6 text-uppercase letter-spacing-1">
                            <div class="form-group">
                                ...
                                <select class="form-control input-add-inception" name="region_code" @error('region_code') is-invalid @enderror>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="village_title" class="form-control" id="exampleInputPassword1" name="village_title" placeholder="Village Title (English)" @error('village_title') is-invalid @enderror>
                                @error('village_title')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" id="price_per_kg" class="form-control" value="" name="price_per_kg" placeholder="Price Per Kg" @error('price_per_kg') is-invalid @enderror>
                                @error('price per kg')
                                <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
