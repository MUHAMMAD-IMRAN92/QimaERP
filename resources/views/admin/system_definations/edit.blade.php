                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form role="form" method="POST" action="{{ route('systemdefinition.update', $defination) }}">
                                {{-- @if ($errors->any())
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="key" id="defination" class="form-control " @error('defination')
                                            is-invalid @enderror>
                                            <option value="genetic" selected>Select Definition</option>
                                            <option value="genetic" @if ($defination->key == 'genetic') selected @endif>Genetice</option>
                                            <option value="flavour" @if ($defination->key == 'flavour') selected @endif>Flavour</option>
                                        </select>
                                        @error('defination')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="name" class="form-control " id="exampleInputPassword1"
                                            name="value" value="{{ $defination->value }}" placeholder="Title">
                                        @error('name')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
