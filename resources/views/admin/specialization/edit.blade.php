                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <p class="text-center">
                                        <a class="btn btn-primary pull-right"  href="{{asset('admin/specializations')}}"><strong>All Specializations   </strong></a> 
                                    </p>
                                    <form method="POST" action="{{url('admin/storespecialization')}}" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="exampleInputCity" value="{{ old('title',$speciality->title) }}" aria-describedby="emailHelp" name="title" placeholder="Enter Specialization">
                                            @if ($errors->has('title'))
