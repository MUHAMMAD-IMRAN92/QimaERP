                                                        ...
                                                        <div class="card set-padding">
                                                            <div class="row">
                                                                <div class="col-md-12 top-margin-set">
                                                                    <h4 class="card-title">Batch Number: {{$batchNumber}} <input type="checkbox" data-gov-rate="<?= $gov ?>" name="transaction_id[]"value="{{$trans['transaction']->transaction_id}}" class="check_gov{{$trans['transaction']->transaction_id}}" onClick="checkGov('<?= $gov ?>',{{$trans['transaction']->transaction_id}})"></h4>
                                                                </div> 
                                                                <div class="col-md-12">
