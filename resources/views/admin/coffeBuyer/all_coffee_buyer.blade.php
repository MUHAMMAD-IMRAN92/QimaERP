        ...
        <div class="mx-lg-5">
                        ...
                        <div class="col-sm-6 d-flex justify-content-end align-items-end">
                            <ol class="breadcrumb float-sm-right">
                                <a href="{{ url('admin/adduser') }}" class="btn btn-add rounded-circle p-0">
                                    <button
                                        class="btn btn-color-darkRed btn-dark bg-transparent border-0 add-button text-uppercase">Add
                                        Coffee Buyer</button>
                                </a>
                                <button
                                    class="btn btn-color-darkRed btn-dark bg-transparent border-0 add-button text-uppercase p-0">&nbsp;|</button>
                                <a href="{{ url('admin/adduser') }}" class="btn btn-add rounded-circle p-0">
                                    <button
                                        class="btn btn-color-darkRed btn-dark bg-transparent border-0 add-button text-uppercase">Add
                                        Coffee Buying Manager</button>
                                </a>
                            </ol>
                        </div>
                    </div>
            ...
            <div class="row ml-2 blacklink letter-spacing-1">
                ...
                <span class="ml-md-2 hover"> <a href="{{ url('admin/coffeeBuyerByDate/' . ($date = 'yesterday')) }}">
                        YESTERDAY</a></span>
                &nbsp |
                <span class="ml-md-2 hover"> <a href="{{ url('admin/coffeeBuyerByDate/' . ($date = 'weekToDate')) }}">
                        WEEK
                        TO DATE
                    </a></span>
                &nbsp |
                <span class="ml-md-2 hover"> <a
                        href="{{ url('admin/coffeeBuyerByDate/' . ($date = 'monthToDate')) }}">MONTH
                        TO
                        DATE</a></span>
                &nbsp |
                <span class="ml-md-2 hover"> <a href="{{ url('admin/coffeeBuyerByDate/' . ($date = 'lastmonth')) }}">
                        LAST
                        MONTH</a></span>
                &nbsp |
                <span class="ml-md-2 hover"> <a
                        href="{{ url('admin/coffeeBuyerByDate/' . ($date = 'yearToDate')) }}">YEAR
                        TO
                        DATE</a></span>
                &nbsp |
                <span class="ml-md-2 hover"> <a href="{{ url('admin/coffeeBuyerByDate/' . ($date = 'currentyear')) }}">
                        2021
                        SEASON</a></span>
                &nbsp |
                <span class="ml-md-2 hover"> <a href="{{ url('admin/coffeeBuyerByDate/' . ($date = 'lastyear')) }}">
                        2020
                        SEASON</a></span>
                &nbsp |
                                        ...
                                        <div class="table-responsive text-uppercase letter-spacing-2 coffee_buyeers_table">
                                            ...
                                            <table class="table table-borderless border-0 custom-table text-center"
                                                ...
                                                <thead>
                                                    <tr>
                                                        <th colspan="12" class="border-0 px-0">
                                                            <div
                                                                class="text-uppercase pl-0 font-weight-lighter table_headers">
                                                                Specialty
                                                            </div>
                                                        </th>
                                                    </tr>
                                                    <tr>
                                                        <th class="border border-dark font-weight-lighter">CHREEY BOUGHT
                                                        </th>
                                                        <th class="border border-dark border-left-0 font-weight-lighter">
                                                            PRICE PAID</th>
                                                ...
                                                <tbody>
                                                    @foreach ($coffeeBuyerMangers as $coffeeBuyerManger)
                                                        <tr>
                                                            <td class="border border-dark border-top-0">
                                                                {{ $coffeeBuyerManger->special_weight }}</td>
                                                            <td class="border border-dark border-left-0 border-top-0">
                                            ...
                                            <table class="table table-borderless border-0 custom-table text-center"
                                                ...
                                                <thead>
                                                    ...
                                                    <th class="border border-dark font-weight-lighter"> <span>DRY
                                                            COFFEE</span> BOUGHT</th>
                                                    <th class="border border-dark border-left-0 font-weight-lighter">PRICE
                                                        PAID</th>
                                                    <th class="border border-dark border-left-0 font-weight-lighter">Total
                                                        Price Paid</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                ...
                                                <tbody>
                                                    @foreach ($coffeeBuyers as $coffeeBuyer)
                                                        <tr>
                                                            ...
                                                            <td class="border border-dark border-top-0">
                                                                {{ $coffeeBuyer->non_special_weight }}</td>
                                                            <td class="border border-dark border-left-0 border-top-0">
                                                                {{ $coffeeBuyer->non_special_price }}</td>
                                                            <td class="border border-dark border-left-0 border-top-0">
                                                                {{ $coffeeBuyer->special_price + $coffeeBuyer->non_special_price }}
                                                            </td>
