    ...
    <section class="content-header mx-lg-5">
        ...
        <div class="row">
            <div class="col-md-4 my-3">
                @if ($buyer->image == null)
                <img class="famerimg ml-4" src="{{ Storage::disk('s3')->url('images/' . 'dumy.png') }}" style="width: 200px ; height:200px; border-radius:50%;" alt="">
                @else
                <img class="famerimg ml-4" style="width:  200px ; height: 200px; border-radius:50%;" src="{{ Storage::disk('s3')->url('images/' . $buyer->image) }}" alt=" no img">
                @endif
            ...
            <div class="col-sm-4 mb-1">
                <ul class="list-group list-group-horizontal">
                    <li class="list-group-item data-content-list">
                        ...
                        @else
                        <img src=" {{ Storage::disk('s3')->url('images/' . $farmer['picture_id']) }}" id="region_farmer">
                        @endif
        ...
        <div class="row ml-2 text-uppercase mb-2 d-flex align-items-center">
            ...
            <a href="{{ url('admin/assignVillages/' . $buyer->user_id) }}" class="btn btn-success bg-Green ml-5 mb-0">Assign
                Villages
            </a>
        </div>
        <div class="row">
            ...
            <div class="col-sm-4 mb-1">
                <ul class="list-group list-group-horizontal">
                    <li class="list-group-item data-content-list">
                        ...
                        <img src="{{ Storage::disk('s3')->url('images/' . 'dumy.png') }}" id="region_farmer">
                        @else
                        <img src="{{ Storage::disk('s3')->url('images/' . $farmer['farmer_image']) }}" id="region_farmer">
                        @endif
