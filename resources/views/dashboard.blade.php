...
<div class="content-wrapper">
    ...
    <div class="content-header">
        ...
        <div class="row ml-2" id="transactions">
            ...
            <div class="col-sm-1 color bg-dark"  style="width:fit-content !important; max-width:20% !important; min-width :10% !important">
                <h3>{{ $totalWeight }}</h3>
                <p>Total Coffee </p>
            </div>
            <div class="col-sm-1 color bg-danger"   style="width:fit-content !important; max-width:20% !important; min-width :10% !important">
                <h3 >{{ $totalPrice }}</h3>
