    ...
    <div class="col-md-5 ">
        <div class="row ml-2 text-uppercase mb-2">
            ...
            <div class="bg-lightGreen text-uppercase mb-2 ml-4 py-2 px-2" style="color: white;min-width: 125px;">
                <div>
                    <h4 class="mb-0">-</h4>
                    <span class="mb-0 font-weight-normal letter-spacing-1" style="font-size: 12px;">Usd Sales</span>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-7">
        ...
        <div class="row mt-3">
            ...
            <div class="col-sm-12">
                ...
                <table class="letter-spaciing-2 text-uppercase table-borderless custom-table-dashboard" style=" height:200px;">
                    <tr align="center">
    ...
    <div class="col-md-7">
        <div class="row ml-2 text-uppercase mb-3">
                ...
                <div class="bg-Green text-uppercase mb-2 ml-4 py-2 px-2" style="color: white;min-width: 125px;">
                    <div>
                        <h4 class="mb-0">-</h4>
                        <span class="mb-0 font-weight-normal letter-spacing-1" style="font-size: 12px;">yer yemen sales</span>
                    </div>
                </div>
        </div>
