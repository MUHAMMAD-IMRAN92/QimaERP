...
return [
    ...
    'ar' => [
        'success_messages' => [
            'LOGIN' => 'Logged In ar',
            'ADD_GOV' => 'Governerate was created Successfully ar',
            'RETRIEVED_GOV' => 'Successfully retrieved Governerate ar',
            'ADD_REGION' => 'Region was created Successfully ar',
            'RETRIEVED_REGION' => 'Successfully retrieved regions ar',
            'ADD_VILLAGE' => 'Village was created Successfully ar',
            'RETRIEVED_VILLAGE' => 'Successfully retrieved village ar',
            'RETRIEVED_FARMER' => 'Successfully retrieved farmers ar',
            'ADD_CONTAINER' => 'Container was created Successfully ar',
            'RETRIEVED_CONTAINER' => 'Successfully retrieved containera ar',
            'RETRIEVED_TRANSACTION' => 'Successfully retrieved transactions ar',
            'RETRIEVED_TRANSACTION_DETAIL' => 'Successfully retrieved transactions details ar',
            'RETRIEVED_BATCHES' => 'Successfully retrieved batches ar',
            'ADD_FARMER' => 'Farmer was created Successfully ar',
            'ADD_COFFEE' => 'Coffee was added Successfully ar',
