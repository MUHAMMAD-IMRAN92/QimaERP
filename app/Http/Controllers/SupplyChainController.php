    ...
    public function supplyChain()
    {
        ...
        foreach ($sentTo as $key => $sent) {
            if ($sent == 2) {
                ...
                $transactions = Transaction::whereYear('created_at', $year)->where('sent_to', 12)
        ...
        foreach ($sentTo as $key => $sent) {
            if ($sent == 2) {
                ...
                $transactions = Transaction::whereYear('created_at', $year)->whereDate('created_at', $today)->where('sent_to', 12)
                    ->orderBy('transaction_id', 'desc')
                    ->get();
            } elseif ($sent == 14) {
    ...
    public function supplyChainDateFilter(Request $request)
    {
        ...
        foreach ($sentTo as $key => $sent) {
            if ($sent == 2) {
                ...
                $transactions =  Transaction::whereBetween('created_at', [$request->from, $request->to])->where('sent_to', 12)
                    ->orderBy('transaction_id', 'desc')->get();
            } elseif ($sent == 14) {
        ...
        if ($date == 'today') {
            ...
            foreach ($sentTo as $key => $sent) {
                if ($sent == 2) {
                    ...
                    $transactions =  Transaction::whereYear('created_at', $year)->whereDate('created_at', $yesterday)->where('sent_to', 12)
                        ->orderBy('transaction_id', 'desc')->get();
                } elseif ($sent == 14) {
            ...
            foreach ($sentTo as $key => $sent) {
                if ($sent == 2) {
                    ...
                    $transactions =  Transaction::whereYear('created_at', $year)->whereMonth('created_at', $lastMonth)->whereYear('created_at', $year)->where('sent_to', 12)
                        ->orderBy('transaction_id', 'desc')->get();
                } elseif ($sent == 14) {
            ...
            foreach ($sentTo as $key => $sent) {
                if ($sent == 2) {
                    ...
                    $transactions =  Transaction::whereYear('created_at', $year)->whereBetween('created_at', [$start, $end])->where('sent_to', 12)
                        ->orderBy('transaction_id', 'desc')->get();
                } elseif ($sent == 14) {
